...
port = 5000
url = '/pconserver/pages/changepressureunit.cgi?'
method = 'GET'
...
# The line below converts the string to a percent-encoded ASCII text string
unit = urlencode({'unit': unit})

connection.request(method, url + unit, headers=headers)
response = connection.getresponse()

print("http://" + ipValue + ":" + str(port) + (url + unit))
