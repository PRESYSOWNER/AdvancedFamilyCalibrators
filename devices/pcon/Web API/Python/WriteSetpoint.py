...
port = 5000
url = '/pconserver/pages/genpressure.cgi?pressureValue={}'
method = 'GET'
...
connection.request(method, url.format(setpoint), headers=headers)
response = connection.getresponse()

print("http://" + ipValue + ":" + str(port) + url.format(setpoint))
